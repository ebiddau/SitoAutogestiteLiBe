...
<style>div.tabella_scelte > table {
  border-collapse: collapse;
  width: 100%;
}

div.tabella_scelte > table > th, td, thead {
...
if ($_SESSION['comm'] != 1 && $_SESSION['aiuto'] != 1){
		...
		?>
		<div class='jumbotron text-center jumbotron-fluid'><span id="scritto">Vedi attività in cui si possono iscrivere ancora persone</span></div>
		<div class="page_text">
